...
@Component
public class CustomThrowsHandler extends BasicHandler {
    ...
    public Mono<ServerResponse> setCustomFormula(ServerRequest serverRequest)
    {
    ...
    public Mono<ServerResponse> resetCustomFormula(ServerRequest serverRequest)
    {
        CustomThrowsRequest customThrowsRequest = readRequest(serverRequest);
        if (customThrowsRequest.getCustomName() == null || customThrowsRequest.getCustomFormula() == null)
            return response(new Error("Insufficent parameters."));
    ...
    public Mono<ServerResponse> deleteCustomFormula(ServerRequest serverRequest)
    {
        CustomThrowsRequest customThrowsRequest = readRequest(serverRequest);
    ...
    public Mono<ServerResponse> listCustomFormula(ServerRequest serverRequest)
    {
        CustomThrowsRequest customThrowsRequest = readRequest(serverRequest);
